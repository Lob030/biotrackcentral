...
import { LayoutDashboard, GitBranch, Package, Layers, FlaskConical, LogOut, BellRing, Boxes, Shield, Users, ShoppingCart, BarChart2, Activity } from "lucide-react";
  ...
  const items = useMemo(() => {
    let list = role === "admin" || isSuperAdmin
      ? [...baseItems, 
          ...
          { title: "IA & Analíticas", url: "/admin/ai-analytics", icon: Activity }
        ]
      : baseItems;
    if (isSuperAdmin) {
